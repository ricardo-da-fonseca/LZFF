...
#' x<-data.frame(id = c("id2", "s3", "id4", "id5", "id6"),
#' sire = c("s3", NA,"s4", "s5", "s6"),dam  = c(NA, NA, "d1", "d2","d3"))
#'
#' #Creating data
#' y<-data.frame(id = paste0("i", 1:5),
...
#' rrcDataPed(dataObj = y, pedObj = x, localData = NULL,localPed = NULL,
#' colsTraits =c(6,7), colsDates = NULL,colsPedData.isd = 1:3,
#' ped.isd = 1:3, sData = " ",dData = ".", hData = FALSE, sPed = " ",
#' hPed = FALSE,md = c(""," ","NA"))
#'
